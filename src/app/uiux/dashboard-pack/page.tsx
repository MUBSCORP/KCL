...
import ColorChip2 from '@/app/uiux/components/modules/topFilter/ColorChip2';
  ...
  const listData = [
    {
      ...
      status: 'rest', // 뱃지 상태: rest(대기), ongoing(진행중), stop(일시정지), alarm(알람), completion(완료)
      statusLabel: '대기', // 뱃지 텍스트: 대기, 진행중, 일시정지, 알람
      voltage: '203.9 aV', // 전압
      current: '31.6 aA', // 전류
      power: '6.44 KW', // 파워
      powerOn: true, // 파워 볼드/레트 표시
      step: '1(Rest)', // 스텝
      cycle: '4/4', // 사이클
      rly: 'ON', // rly
      chamber: '0.9', // 챔버
